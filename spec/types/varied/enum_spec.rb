...
RSpec.describe 'SmartCore::Types::Varied::Enum' do
  context 'non-nilable type' do
    let(:type) { SmartCore::Types::Varied::Enum.of(10, '20', false) }
  ...
  context 'nilable type' do
    let(:type) { SmartCore::Types::Varied::Enum.of(10, '20', false).nilable }
